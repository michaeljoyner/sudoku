  ...
  <div id="app" class="min-h-screen bg-gray-800 relative overflow-hidden">
    <div class="h-12 bg-gray-800 flex items-center justify-between px-4">
      ...
      <button @click="showNav = !showNav">
        <svg
          class="fill-current text-yellow-500 h-6"
    ...
    <div
      :class="{'show': showNav}"
      class="w-screen bg-gray-800 text-yellow-500 absolute nav-drawer"
    >
      <div class="text-center pt-20 text-yellow-500">
        <p class="text-3xl font-black mb-6">Menu</p>
        <a href="#" @click.prevent="toNewGame">New Game</a>
      </div>
    </div>
  </div>
</template>
